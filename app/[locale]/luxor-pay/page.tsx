    ...
    return (
        <div className="min-h-screen bg-black flex items-center justify-center px-6 relative overflow-hidden font-sans">
            ...
            <div className="max-w-4xl text-center relative z-10">
                ...
                >
                    <span className="text-blue-500 font-bold uppercase tracking-[0.3em] text-[10px] mb-8 block">Project in Progress</span>
                    ...
                    <p className="mt-8 text-white/40 text-sm md:text-base font-light max-w-lg mx-auto leading-relaxed">
                        We are building the future of instant, secure, and decentralized payments. Luxor Pay will revolutionize how you interact with value.
                    </p>
                </motion.div>
